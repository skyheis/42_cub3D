...
/*   Updated: 2023/05/05 23:45:37 by ggiannit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_hooks(int keycode, t_mlxvars *meta)
{
	...
	{
		printf("UP\n");
		if(meta->map.map[(int)(plr->posX + plr->dirX * plr->moveSpeed)][(int)plr->posY] == false)
			plr->posX += plr->dirX * plr->moveSpeed;
		if(meta->map.map[(int)plr->posX][(int)(plr->posY + plr->dirY * plr->moveSpeed)] == false)
